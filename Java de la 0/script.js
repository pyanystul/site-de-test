...
// console.log(rezultat(90, 10));
//     ====================================================================================COUNTER===========================
//     let data = 0;

//     function adunare() {
//       data = data + 1;
//       document.getElementById("afisare").innerText = data;
//       document.getElementById("afisareRosie").innerText = data;

// ============================================================================================================================

//       if(data > 1 || data == 0) {
        
//         document.getElementById('afisareRosie').style.display = 'none';
//         document.getElementById('afisare').style.display = 'flex';
//     }
// }
...
//         document.getElementById('afisareRosie').style.display = 'flex';
